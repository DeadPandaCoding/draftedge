...
export const RedditIcon = (p: IconProps) => (
  <svg viewBox="0 0 24 24" width={p.size ?? 16} height={p.size ?? 16} fill="currentColor" aria-hidden="true">
    <path d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.553 4.672 1.231a1.51 1.51 0 0 1 1.349-.707c.84 0 1.522.681 1.522 1.519 0 .595-.34 1.113-.835 1.365a4.02 4.02 0 0 1 .058.5c0 2.696-3.119 4.884-6.963 4.884-3.845 0-6.963-2.188-6.963-4.884 0-.17.01-.34.028-.509a1.506 1.506 0 0 1-.844-1.36c0-.837.682-1.519 1.52-1.519.47 0 .884.213 1.153.546 1.243-.71 2.943-1.21 4.809-1.3l.865-4.052 3.246.697a1.25 1.25 0 0 1 1.15-1.242zm-6.994 9.34c.74 0 1.34.6 1.34 1.34 0 .739-.6 1.338-1.34 1.338-.74 0-1.34-.599-1.34-1.338 0-.74.6-1.34 1.34-1.34zm5.056 3.104c.578.58 1.53.84 2.696.84 1.166 0 2.118-.26 2.696-.84a.376.376 0 0 0-.53-.533c-.39.39-1.045.672-2.166.672s-1.776-.282-2.165-.672a.376.376 0 0 0-.531.533zm-1.878-1.764c.74 0 1.34.599 1.34 1.338 0 .74-.6 1.34-1.34 1.34-.739 0-1.34-.6-1.34-1.34 0-.739.601-1.338 1.34-1.338z" />
  </svg>
);
