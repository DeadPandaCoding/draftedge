...
export default function FoldText({
  ...
  useEffect(() => {
    ...
    if (trigger === "hover") {
      ...
      // "mount" — snap to the folded state before playing so there's no
      // flash of the fully-unfolded text on hydrate.
      gsap.set(pieces, fromVars);
      play(false);
    }
